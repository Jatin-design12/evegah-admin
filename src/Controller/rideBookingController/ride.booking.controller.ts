...
const rideBookingController = async (req: Request, res: Response) => {
    try {
        ...
        if (
            CommonMessage.IsValid(requestBody.id) == false &&
            CommonMessage.IsValid(requestBody.vehicleId) == false &&
            CommonMessage.IsValid(requestBody.uId) == false &&
            CommonMessage.IsValid(requestBody.lockId) == false &&
            CommonMessage.IsValid(requestBody.rideBookingMinutes) == false
        ) {
...
const updateDetailsRideEndsController = async (req: Request, res: Response) => {
    ...
    try {
        ...
        let thirdPartyLockUnlockResponseData: any = { massage: null, result: null };
