...
//console.log('check jhh,querylatlong',querylatlong)
    ...
    async updateWithdrawRequestFromAdminSide(user: any, req :any) {
        return new Promise(async (resolve, reject) => {
            ...
            user.requestId.forEach(async (value: any, i: number) => {
                ...
                let actionOnDate = getUTCdate();
                let query: any = { text: DB_CONFIGS.customerQueries.updateStatusOfWithdrawRequest(), values: [user.withdrawRequestStatusEnumId, actionOnDate, user.requestId ,actionOnDate,user.processing_user_id] };
    ...
    async updateStatusCancelledOfWithdrawRequest(user: any, req :any) {
        return new Promise(async (resolve, reject) => {
            ...
            //     user.requestId = value;
                let actionOnDate = getUTCdate();
                let query: any = { text: DB_CONFIGS.customerQueries.updateStatusCancelledOfWithdrawRequest(), values: [user.withdrawRequestStatusEnumId, actionOnDate, user.requestId ,actionOnDate,user.cancelled_user_id,user.remarks ] };
               // console.log('check quary getWithdrawRequestFromUser',query)
                try {
                    let result = await client.query(query);
                    finalResult.push(result);
        ...
        return new Promise(async (resolve, reject) => {
            ...
            user.requestId.forEach(async (value: any, i: number) => {
                ...
                let query: any = {
                    ...
                    values: [user.withdrawRequestStatusEnumId, user.payment_id, user.entity, user.currency, user.status, user.method, user.description, actionOnDate, user.requestId ,actionOnDate,user.completed_user_id]
                };
    ...
    async getAllTransaction(user: any, req:any) {
        let query: any = { text: DB_CONFIGS.userTransaction.getAllTransaction(),
             values: [user.id, user.userName,user.mobileNo,user.transactionTypeEnumId] };
    ...
    async bikeBatteryStatusLessThenTwenty( requestQuery :any , req:any) {
        let query: any = { text: DB_CONFIGS.adminQueries.adminDashboardQueries.getProduceBikeBatteryStatusLessThenTwenty(),
...
//console.log('batteryArray',batteryArray)
    ...
    async produceBikeBatteryStatusGraterThenTwentyAndLessThenFifty(requestQuery :any, req:any ) {
        let query: any = { text: DB_CONFIGS.adminQueries.adminDashboardQueries.getProduceBikeBatteryStatusGraterThenTwentyAndLessThenFifty(), 
            values: [requestQuery.mapCountryName,requestQuery.mapStateName,requestQuery.mapCityName] };
        return new Promise(async (resolve, reject) => {
            try {
                let batteryArray: any = [];
    ...
    async produceBikeBatteryStatusGraterThenFifty(requestQuery :any, req:any) {
        let query: any = { text: DB_CONFIGS.adminQueries.adminDashboardQueries.getProduceBikeBatteryStatusGraterThenFifty(),
             values: [requestQuery.mapCountryName,requestQuery.mapStateName,requestQuery.mapCityName] };
        return new Promise(async (resolve, reject) => {
            try {
                let batteryArray: any = [];
...
//-----
    ...
    async insertVersionDetail(requestBody: any, req :any ) {
        ...
        let query: any = {
            text: DB_CONFIGS.versionQueries.insertVersion(),
                values: [requestBody.displayVersion ,requestBody.actualVersion ,requestBody.minSupportableVersion,requestBody.remark ,requestBody.versionApplyDate ,requestBody.createdOnDate ,requestBody.createdByLoginUserId] 
        };        
        return new Promise(async (resolve, reject) => {
            try {
                let result = await client.query(query);
    ...
    async updateAppUserVersion(req: any, res :any ) {
        ...
        let query: any = {
            ...
            values: [requestBody.versionId, requestBody.displayVersion ,requestBody.actualVersion ,requestBody.minSupportableVersion,requestBody.actionRemark ,requestBody.versionApplyDate ,requestBody.createdOnDate ,requestBody.createdByLoginUserId] 
        };        
