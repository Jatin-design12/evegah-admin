...
class AreaMasters 
{
    ...
    async insertAreaDetails (areaDetails: any, req :any)
    {
        ...
        let query :any = { text :DB_CONFIGS.areaMasters.insertAreaDetail(),
                           values:
                           [
                            areaDetails.name ,                                                       
...
AddExceptionIntoDB(req,error);
    ...
    {
        let actionsDate= getUTCdate();
        let query :any = { text :DB_CONFIGS.areaMasters.updateAreaDetail(),
                           values:
                           [
                            areaDetails.areaId,
                            areaDetails.name ,                           
    ...
    async insertFarePlanDetail (fareDetails: any,req:any)
    {
        ...
        let query :any = { text :DB_CONFIGS.farePlanMasters.insertFarePlanDetail(),
                           values:
                           [
                            fareDetails.mapCityId ,fareDetails.areaTypeEnumId,fareDetails.areaId ,fareDetails.modelId ,fareDetails.aplicableDate ,fareDetails.perMinuteRateMonday ,
                            fareDetails.perMinuteRateTuesday ,fareDetails.perMinuteRateWednesday ,fareDetails.perMinuteRateThursday ,fareDetails.perMinuteRateFriday ,
                            fareDetails.perMinuteRateSaturday ,fareDetails.perMinuteRateSunday ,fareDetails.statusEnumId ,actionsDate ,fareDetails.createdyId,fareDetails.hireTimeInMinuts                        
                           ]
                        };
    ...
    {
        let actionsDate= getUTCdate();
        let query :any = { text :DB_CONFIGS.farePlanMasters.updateFarePlanDetail(),
                           values:
                           [
